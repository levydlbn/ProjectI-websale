    ...
    return ( 
        ...
        <div className = "footer__above row col c-12" > {
            listPages.map((item) => ( 
                ...
                <Link to = "/"
                className = "footer__above-item-header-title" > { item.title } 
                </Link>   
                </div>  <div className = "footer__above-item-body" >
                <Link to = "/"
                className = "footer__above-list-page" > { item.page1 } 
                </Link>   
                <Link to = "/"
                className = "footer__above-list-page" > { item.page2 } 
                </Link>   
                <Link to = "/"
                className = "footer__above-list-page" > { item.page3 } 
                </Link>   
                </div>  
                </div>
            ))
